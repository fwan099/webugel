            ...
            <div class="card shadow-lg content2 ">
                <div class="card-body">
                    ...
                    <form class="mt-4" method="post">
                        ...
                        <div class="mb-3">
                            <input type="text" class="form-control border_input"  placeholder="Usuario" autofocus
                                id="txt-user">
                        </div>

                        <div class="mb-3">
                            <input type="password" class="form-control border_input"  placeholder="Contraseña"
                                id="txt-pass">
                        </div>
                        ...
                        <div class="d-grid mt-4">
                            <button class="btn btn_login btn-lg text-white" type="button"
                                onclick="iniciar_sesion()">Ingresar</button>
                        </div>
                    </form>
                </div>
            </div>
