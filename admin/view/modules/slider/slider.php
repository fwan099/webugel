    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-3">
                        <label for="">Orden de Presentación (*)</label>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-outline-secondary" onclick="Registrar_Slider()">Registrar</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="modal_editar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="input-group col-lg-12 mb-3 flex-column ">
                        <label for="">Subir Vista Previa PNG/JPG 960x300 Pixeles (*)</label><br>
                        <div class="">
                            <img src="" id="txt_img_edit" class="img-fluid" alt=""
                                width="300">
                                <input type="file" class="form-control-file d-none" id="inputFile_edit">
                        <button type="button" class="btn btn-icon"
                            onclick="document.getElementById('inputFile_edit').click();">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-outline-danger" data-bs-dismiss="modal">Cerrar</button>
                <button type="button" class="btn btn-outline-secondary" onclick="Modificar_Slider()">Modificar</button>
            </div>
        </div>
    </div>
</div>
